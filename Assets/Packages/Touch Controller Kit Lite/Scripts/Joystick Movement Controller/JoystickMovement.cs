...
public class JoystickMovement : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
	...
	public Vector2 joystickHandleImgInitialPosition;
 ...
 //   Vector2 ResetPos;
    ...
    void Awake()
    {
     ...
     ///   ResetPos = joystickAreaImg.transform.position;
    }
    ...
    public virtual void OnPointerDown(PointerEventData eventData)
    {
        ...
        joystickAreaImg.transform.position = Input.mousePosition;
        OnDrag(eventData);
    }
    ...
    {
        // joystickAreaImg.transform.position = ResetPos;
